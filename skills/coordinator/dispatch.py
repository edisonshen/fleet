...
def build_worker_prompt(
    ...
    *,
    ...
    # verification.md; the coord tick's finisher (finisher.py) copies
    # its sections verbatim into the PR body (or the non-git done note),
    # so the wording of the section headers here is load-bearing for its
...
# build_worker_prompt to derive a coord-engine-
...
def build_reviewer_prompt(
    ...
    *,
    ...
    both_cmd = (
        f"python3 {skill_home}/skills/coordinator/review_slot.py --both "
    ...
    if resolution.alpha_is_helper:
        ...
        alpha_exit2_note = (
            f"   - exit 2 => {alpha.engine} slot skipped (`skip_reason` in the report: "
