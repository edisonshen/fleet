...
def build_rebase_prompt(action, *, standards_md: str = "") -> str:
    ...
    lines = [
        ...
        "",
        "## Read first",
        "- your engine's global Subagent Dispatch Contract: claude reads",
        "  ~/.claude/CLAUDE.md; codex reads ~/.codex/AGENTS.md. Read whichever",
        "  exists for the engine you're running.",
