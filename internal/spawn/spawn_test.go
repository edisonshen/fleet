...
func TestSpawn_RuntimeEnvPropagated(t *testing.T) {
	...
	// Single-shot rollback escape hatch must reach the spawned coord's pane,
	...
	wants := []string{
		...
		"BUF=1234", "VER=456", "RTY=789", "SBT=3s", "ITS=1", "CG=off", "CXH=/cxh", "ROLE=worker",
