...
//
//go:embed skills/coordinator/SKILL.md skills/coordinator/loop.py skills/coordinator/parse.py skills/coordinator/dispatch.py skills/coordinator/conflict.py
