...
//
//go:embed skills/coordinator/SKILL.md skills/coordinator/loop.py skills/coordinator/parse.py skills/coordinator/dispatch.py skills/coordinator/conflict.py skills/coordinator/worktree.py skills/coordinator/remote_control.py skills/coordinator/supervisor.py skills/coordinator/reaper.py skills/coordinator/register_subagent.py skills/coordinator/handoff_resume.py skills/coordinator/workflow_state.py skills/coordinator/coord_config.py skills/coordinator/pr_watch.py skills/coordinator/watchchan.py skills/coordinator/fleetlog.py skills/coordinator/review_slot.py skills/coordinator/reviewcfg.py skills/coordinator/finisher.py
