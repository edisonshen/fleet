...
//
//go:embed skills/fleet-guard/SKILL.md skills/fleet-guard/main.py skills/fleet-guard/health.py skills/fleet-guard/handoff.py skills/fleet-guard/inbox.py skills/fleet-guard/jetsam.py skills/fleet-guard/coordguard.py skills/fleet-guard/decisions.py
...
//
//go:embed skills/coordinator/SKILL.md skills/coordinator/loop.py skills/coordinator/parse.py skills/coordinator/dispatch.py skills/coordinator/conflict.py skills/coordinator/worktree.py skills/coordinator/remote_control.py skills/coordinator/supervisor.py skills/coordinator/reaper.py skills/coordinator/register_subagent.py skills/coordinator/handoff_resume.py skills/coordinator/workflow_state.py skills/coordinator/coord_config.py skills/coordinator/pr_watch.py skills/coordinator/watchchan.py skills/coordinator/fleetlog.py skills/coordinator/review_slot.py skills/coordinator/reviewcfg.py skills/coordinator/workercfg.py skills/coordinator/finisher.py
